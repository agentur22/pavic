...
<section class="blog detail">
    <div class="grid-container">
        <div class="grid-x titel-img">
            <div class="cell">
                <img src="/assets/img/article_image.png" alt="Bild" />
            </div>
        </div>
            ...
            <div class="cell large-offset-2 large-8">
                ...
                <div class="grid-x grid-margin-x">
                    <div class="cell large-3">
                        <img src="/assets/img/author-avatar.png" alt="Bild" />
                    </div>
